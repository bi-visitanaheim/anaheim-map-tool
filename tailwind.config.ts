    ...
    extend: {
      ...
      colors: {
        ...
        anaheim: {
          ...
          navy: "hsl(var(--anaheim-navy))",
          gold: "hsl(var(--anaheim-gold))",
        },
        marker: {
          bg: "hsl(var(--marker-bg))",
          text: "hsl(var(--marker-text))",
          border: "hsl(var(--marker-border))",
        },
        panel: {
          bg: "hsl(var(--panel-bg))",
      ...
      boxShadow: {
        ...
        "marker": "0 2px 8px rgba(0, 0, 0, 0.25)",
      },
    },
  },
